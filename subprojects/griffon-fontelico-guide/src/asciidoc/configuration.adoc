...
----
dependencies {
    griffon '{project-group}:griffon-fontelico-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fontelico-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fontelico-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fontelico-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-fontelico-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-fontelico-plugin` BOM in your POM file, by placing the following
