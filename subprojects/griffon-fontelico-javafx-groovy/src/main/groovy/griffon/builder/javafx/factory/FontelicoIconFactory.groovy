 ...
 */
public class FontelicoIconFactory extends LabeledFactory {
    FontelicoIconFactory() {
        super(FontelicoIcon)
    }
    ...
    public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
        ...
        if (iconName instanceof CharSequence) {
            FontelicoIcon icon = new FontelicoIcon(iconName.toString())
            icon.iconSize = iconSize.toInteger()
            return icon
        } else if (iconName instanceof Fontelico) {
            FontelicoIcon icon = new FontelicoIcon((Fontelico) iconName)
            icon.iconSize = iconSize.toInteger()
            return icon
        }
